...
## Step 1: Read the Approved Intake and Interview

Read the approved `INTAKE.md` and `INTERVIEW.md` for this sprint. These documents already capture what the human wants, why, any stated constraints, and any gaps that were surfaced and resolved during the Interview stage — proceed directly to extracting requirements from them.
